  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color:  blueviolet;">
    <div class="dropdown" style="background-color: blueviolet;">
    ...
    <div class="sidebar pb-4 mb-4" style="background-color:  blue">
      <nav class="mt-2">
